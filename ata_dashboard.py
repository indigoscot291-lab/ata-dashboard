...
# --- PAGE 3: National & District Rings ---
    ...
    #RINGS_SHEET_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRWVqaFh-t631NUnG02NKhFgIqsoa5xApfWCDp-dwLhJidzk_PSTa8UVrBYCmDlOQ/pub?gid=410820480&single=true&widget=true&headers=false"
    ...
    try:
        ...
        rings_df = rings_df.applymap(lambda x: x.replace('\n', ' ').strip() if isinstance(x, str) else x)
    ...
    try:
        ...
        members_df = members_df.applymap(lambda x: x.strip() if isinstance(x, str) else x)
